...
print("READ-ONLY RUNTIME VERIFICATION v0.3")
print("=" * 80)
...
check(
    ...
    and x.data["symbols"][0]["status"] == "TRADING"
)
...
check(
    ...
    not bc[CAPABILITY_ORDER_SUBMISSION]
    and not bc[CAPABILITY_ORDER_CANCELLATION]
    and not bc[CAPABILITY_WITHDRAWAL]
    and not tc[CAPABILITY_ORDER_SUBMISSION]
    and not tc[CAPABILITY_ORDER_CANCELLATION]
    and not tc[CAPABILITY_WITHDRAWAL]
)
