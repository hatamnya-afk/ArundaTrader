...
from market_analysis_engine import calculate_snapshot
...
# ============================================================================
# MARKET RECORD Ã¢â€ â€™ MARKET ARM INPUT
# ============================================================================
...
def build_features(
    ...
    # ------------------------------------------------------------
    # Structure -> Feature contract adapter.
    #
    # REAL structure metadata only.
    # No inference.
    # No strategy change.
    # No threshold change.
    # No synthetic values.
    ...
    structure_direction = structure_result.get(
        "direction"
    )

    structure_strength = structure_result.get(
        "strength"
    )

    structure_confidence = structure_result.get(
        "confidence"
    )
    ...
    for structure in structures:
        ...
        if structure is None:
            feature_structures.append(None)
            continue
...
# ============================================================================
# FEATURE Ã¢â€ â€™ PRODUCTION SIGNAL INPUT
# ============================================================================
...
def feature_to_production_signal_input(
    ...
    return ProductionSignalInput(
        ...
        trend=None,
        momentum=None,
        acceleration=market_snapshot.get(
            "acceleration"
        ),
        position=market_snapshot.get(
            "position"
        ),
...
def build_production_signal_input(
    ...
    feature_record = features[-1]
            ...
            # ------------------------------------------------------------
    # Existing market-analysis snapshot.
    #
    # REAL validated production rows only.
    # No DB read.
    # No interpolation.
    # No fill/backfill.
    #
    # Adapter only:
    # canonical close -> snapshot price
    ...
    market_snapshot = calculate_snapshot(
        market_input["asset"],
        snapshot_window,
    )
...
def main() -> int:
    ...
    for record in samples:
        ...
        # ------------------------------------------------------------
        # MarketRecord Ã¢â€ â€™ MarketArmInput
        # ------------------------------------------------------------
        ...
        # ------------------------------------------------------------
        # MarketArmInput Ã¢â€ â€™ real market data Ã¢â€ â€™
        # analysis engines Ã¢â€ â€™ ProductionSignalInput
        # ------------------------------------------------------------
    ...
    print(
        "FINAL_GATE="
        "REAL MARKET DATA Ã¢â€ â€™ PRODUCTION SIGNAL INPUT = PASS"
    )
