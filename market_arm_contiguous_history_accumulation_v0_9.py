...
# ============================================================
# ARUNDA MARKET ARM
# CONTIGUOUS HISTORY ACCUMULATION v0.9
#
# PURPOSE:
...
#
# v0.9 SURGICAL FIX:
#   Historical request window is based on TARGET_RUN,
#   NOT on remaining NEEDED candles.
#
#   request_end   = latest_closed
#   request_start = latest_closed
#                   - (TARGET_RUN + HISTORY_BUFFER_CANDLES)
#                   * TIMEFRAME_SECONDS
#
# OPEN CURRENT CANDLE:
#   NEVER COUNTED
...
#
# RAW KuCoin rows retained.
#
# Existing adapter owns:
#   normalize()
#   validate_candle()
#
# OPEN CANDLE IS REJECTED BEFORE NORMALIZATION.
# ============================================================
...
def main():
    ...
    print(
        "REQUEST_WINDOW_BASIS=TARGET_RUN"
    )
    ...
    print(
        "REQUEST_END_EQUALS_LATEST_CLOSED=True"
    )

    print(
        "REQUEST_START_USES_TARGET_RUN=True"
    )
    ...
    store = load_module(
        STORE_MODULE,
        "canonical_store_v0_9"
    )


    kucoin = load_module(
        KUCOIN_MODULE,
        "public_market_data_kucoin_v0_9"
    )
    ...
    try:
        ...
        for asset in ASSETS:
            ...
            # v0.9 SURGICAL FIX
            #
            # REQUEST WINDOW IS BASED ON TARGET_RUN.
            #
            # NOT:
            #
            #   needed + buffer
